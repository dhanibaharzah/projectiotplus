...
<div class="col-md-<?php echo 12/$ena; ?> col-xs-6 text-center">
    ...
    <p>Feedwater pH <br> <b><span id="col<?php echo $mc_name_1; ?>"></span></b> <?php echo $unit_1; ?></p>
</div>
<?php if($ena > 1){ ?>
<div class="col-md-<?php echo 12/$ena; ?> col-xs-6 text-center">
    <canvas id="gauge2<?php echo $ajax_link; ?>"></canvas>
    <p>Boiler pH <br> <b><span id="col<?php echo $mc_name_2; ?>"></span></b> <?php echo $unit_2; ?></p>
</div>
<?php }if($ena > 2){ ?>
<div class="col-md-<?php echo 12/$ena; ?> col-xs-6 text-center">
    <canvas id="gauge3<?php echo $ajax_link; ?>"></canvas>
    <p>Blowdown pH <br> <b><span id="col<?php echo $mc_name_3; ?>"></span></b> <?php echo $unit_3; ?></p>
</div>
<?php }if($ena > 3){ ?>
<div class="col-md-<?php echo 12/$ena; ?> col-xs-6 text-center">
    <canvas id="gauge4<?php echo $ajax_link; ?>"></canvas>
    <p><?php echo $mc_name_4; ?> <?php echo $unit_4; ?> <br> <b><span id="col<?php echo $mc_name_4; ?>"></span></b> </p>
</div>
<?php } ?>
<script>
    ...
    var gauge1<?php echo $ajax_link; ?> = new RadialGauge({
		...
		highlights: [
				{
					"from": <?php if(!empty($lower_tick1)){echo $lower_tick1; }else{echo '0';}?>, "to": 8.5,
					"color": "<?php echo $color_start1; ?>"//"#ff6363" //RED
				},{
					"from": 8.5, "to": 10,
					"color": "<?php if(!empty($color_mid1)){ echo $color_mid1;} else{echo "rgb(0, 255,0)";} ?>" //YELLOW
				},{
					"from":10, "to": 14,
					"color": "<?php echo $color_start1; ?>"//"rgb(86, 244, 65)" //GREEN
				}
			],
		colorPlate: "#fff",
		borderShadowWidth: 0,
...
<?php if($ena > 1){ ?>
    ...
    var gauge2<?php echo $ajax_link; ?> = new RadialGauge({
		...
		highlights: [
			{
					"from": <?php if(!empty($lower_tick2)){echo $lower_tick2; }else{echo '0';}?>, "to": 10.5,
					"color": "<?php echo $color_start2; ?>"//"#ff6363" //RED
				},{
					"from": 10.5, "to": 12,
					"color": "<?php if(!empty($color_mid2)){ echo $color_mid2;} else{echo "rgb(0, 255,0)";} ?>" //YELLOW
				},{
					"from":12, "to": 14,
					"color": "<?php echo $color_start2; ?>"//"rgb(86, 244, 65)" //GREEN
				}
			],
		colorPlate: "#fff",
		borderShadowWidth: 0,
...
<?php }if($ena > 2){ ?>
    ...
    var gauge3<?php echo $ajax_link; ?> = new RadialGauge({
		...
		highlights: [
				{
					"from": <?php if(!empty($lower_tick3)){echo $lower_tick3; }else{echo '0';}?>, "to": lim3_1<?php echo $ajax_link; ?>,
					"color": "#ffffff" //RED
				},{
					"from": lim3_1<?php echo $ajax_link; ?>, "to": lim3_2<?php echo $ajax_link; ?>,
					"color": "<?php if(!empty($color_mid3)){ echo $color_mid3;} else{echo "rgb(255, 255, 255)";} ?>" //YELLOW
				},{
					"from": lim3_2<?php echo $ajax_link; ?>, "to": lim3_3<?php echo $ajax_link; ?>,
