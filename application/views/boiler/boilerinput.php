						...
						<div class="row">
							<div class="col-lg-4 col-xs-12">
								<div class="row">
									...
									<div class="form-group input-group">
										<input class="form-control input-sm" name="boiler_steam_press" disabled type="text" 
										placeholder="Autolog">
								...
								<div class="row">
									...
									<div class="col-md-6">
									<div class="form-group input-group">
										<input class="form-control input-sm" name="steam_out" disabled type="text"
										placeholder="Autolog" >
								...
								<div class="row">
									...
									<div class="col-md-6">
									<div class="form-group input-group">
										<input class="form-control input-sm" name="feed_tank_lvl" disabled type="text"
										placeholder="Autolog" >
								...
								<div class="row">
									...
									<div class="col-md-6">
									<div class="form-group input-group">
										<input class="form-control input-sm" name="id_fan" disabled type="text"
										placeholder="Autolog" >
								...
								<div class="row">
									...
									<div class="col-md-6">
									<div class="form-group input-group">
										<input class="form-control input-sm" name="fd_fan" disabled type="text"
										placeholder="Autolog" >
										<span class="input-group-addon">Hz</span>
									</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
									<div class="form-group input-group">
										<input class="form-control input-sm" name="flue_gas_temp" disabled type="text"
										placeholder="Autolog" >
										<span class="input-group-addon">&#8451;</span>
									</div>
									</div>
							...
							<div class="col-md-4">
								...
								<div class="row">
									...
									<div class="col-md-6">
									<div class="form-group input-group">
										<input class="form-control input-sm" name="bed_temp2" disabled type="text"
										placeholder="Autolog" >
										<span class="input-group-addon">&#8451;</span>
									</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
									<div class="form-group input-group">
										<input class="form-control input-sm" name="water_lvl_boiler" disabled type="text"
										placeholder="Autolog" >
										<span class="input-group-addon">%</span>
									</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
									<div class="form-group input-group">
										<input class="form-control input-sm" name="screw_feed_1" disabled type="text"
										placeholder="Autolog" >
										<span class="input-group-addon">Hz</span>
									</div>
									</div>
							...
							<div class="col-lg-4">
								<div class="row">
									...
									<div class="col-md-6">
									<div class="form-group input-group">
										<input class="form-control input-sm" name="screw_feed_2" disabled type="text"
										placeholder="Autolog" >
										<span class="input-group-addon">Hz</span>
									</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
									<div class="form-group input-group">
										<input class="form-control input-sm" name="deaerator" disabled type="text"
										placeholder="Autolog" >
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group input-group">
										<input class="form-control input-sm" name="recir_fan" disabled type="text"
										placeholder="Autolog" >
										<span class="input-group-addon">Hz</span>
									</div>
									</div>
			...
			<div class="col-md-12">
				...
				<form role="form" id="addtool" action="<?php echo base_url() ?>addboilerinput3" method="post" role="form">
					...
					<div class="box-body table-responsive">
						...
						<input type="number" class="form-control input-sm" name="flow_rate " step="0.1" required/>
						<table class="table table-hover table-striped table-bordered ">
							...
							<tr>
								<th>Tot. Hardness</th>
								<th>ppm CaCO3</th>
								<td><input type="number" class="form-control input-sm" name="sc_1" step="0.1" required/></td>
								<td><input type="number" class="form-control input-sm" name="sf_1" required/></td>
								<td></td>
								<td></td>
								<td><input type="number" class="form-control input-sm" name="ce_1" step="0.1" required/></td>
								<td><input type="number" class="form-control input-sm" name="ae_1" step="0.1" required/></td>
								<td><input type="number" class="form-control input-sm" name="bt_1" step="0.1" required/></td>
								<td><input type="number" class="form-control input-sm" name="bf_1" step="0.1" required/></td>
								<td><input type="number" class="form-control input-sm" name="bl_1" step="0.1" required/></td>
								<td><input type="number" class="form-control input-sm" name="bd_1" step="0.1" required/></td>
							</tr>
							<tr>
								<th>pH</th>
								<th></th>
								<td><input type="number" class="form-control input-sm" name="sc_2" step="0.01" required/></td>
								<td><input type="number" class="form-control input-sm" name="sf_2" step="0.01" required/></td>
								<td></td>
								<td></td>
								<td><input type="number" class="form-control input-sm" name="ce_2" step="0.01" required/></td>
								<td><input type="number" class="form-control input-sm" name="ae_2" step="0.01" required/></td>
								<td><input type="number" class="form-control input-sm" name="bt_2" step="0.01" required/></td>
								<td><input type="number" class="form-control input-sm" name="bf_2" step="0.01" required/></td>
								<td><input type="number" class="form-control input-sm" name="bl_2" step="0.01" required/></td>
								<td><input type="number" class="form-control input-sm" name="bd_2" step="0.01" required/></td>
							</tr>
							<tr>
								<th>Conductivity</th>
								<th>uS/cm</th>
								<td><input type="number" class="form-control input-sm" name="sc_3" step="0.1" required/></td>
								<td><input type="number" class="form-control input-sm" name="sf_3" step="0.1" required/></td>
								<td></td>
								<td></td>
								<td><input type="number" class="form-control input-sm" name="ce_3" step="0.1" required/></td>
								<td><input type="number" class="form-control input-sm" name="ae_3" step="0.1" required/></td>
								<td><input type="number" class="form-control input-sm" name="bt_3" step="0.1" required/></td>
								<td><input type="number" class="form-control input-sm" name="bf_3" step="0.1" required/></td>
								<td><input type="number" class="form-control input-sm" name="bl_3" step="0.1" required/></td>
								<td><input type="number" class="form-control input-sm" name="bd_3" step="0.1" required/></td>
							</tr>
							<tr>
								<th>Turbidity</th>
								<th>NTU</th>
								<td><input type="number" class="form-control input-sm" name="sc_4" step="0.01" required/></td>
								<td><input type="number" class="form-control input-sm" name="sf_4" step="0.01" required/></td>
								<td></td>
								<td><input type="number" class="form-control input-sm" name="ca_4" step="0.01" required/></td>
								<td><input type="number" class="form-control input-sm" name="ce_4" step="0.01" required/></td>
								<td><input type="number" class="form-control input-sm" name="ae_4" step="0.01" required/></td>
								<td><input type="number" class="form-control input-sm" name="bt_4" step="0.01" required/></td>
								<td><input type="number" class="form-control input-sm" name="bf_4" step="0.01" required/></td>
								<td><input type="number" class="form-control input-sm" name="bl_4" step="0.01" required/></td>
								<td><input type="number" class="form-control input-sm" name="bd_4" step="0.01" required/></td>
							</tr>
						</table>
					</div>
					<div class="box-footer">
