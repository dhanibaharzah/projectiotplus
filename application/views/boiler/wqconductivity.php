...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Electric Conductivity<small>Boiler Water Quality</small>
      </h1>
    </section>
    <section class="content-header">
		<div class="box-tools">
			<form action="<?php echo base_url() ?>wqconductivity" method="POST" id="searchList">
...
//EC=============================================================		
var chartac = Highcharts.chart('ecboi', {
		chart: {
			height: 250,
			type: 'line',
			alignTicks: false
...
//EC=============================================================		
var chartac = Highcharts.chart('ecfw', {
		chart: {
			height: 250,
			type: 'line',
			alignTicks: false
		...
		series: [{
			name: 'EC Feed Water', type: 'line', yAxis: 1,
			data: [<?php echo $ec3 ?>],
			tooltip: { valueSuffix: ' uS/cm'}
			}]
		});

var chartac = Highcharts.chart('ecblow', {
		chart: {
			height: 250,
			type: 'line',
			alignTicks: false
		...
		series: [{
			name: 'EC Blowdown', type: 'line', yAxis: 1,
			data: [<?php echo $ec1 ?>],
			tooltip: { valueSuffix: ' uS/cm'}
			}]
		});											
