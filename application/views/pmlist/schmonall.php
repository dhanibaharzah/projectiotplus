			...
			<div class="table-responsive no-padding">
				...
				?>
					<tr style="border: 1px solid black">
						...
						<td <?php if($record->closed == 1){ echo 'bgcolor="#00FF00"';} ?> style="border: 1px solid black; padding:2px;"><p style="line-height: 1.1"><font size="1"><?php echo '<b>Owner:</b>'.$record->owner.'<br><b>'.$record->job_title.'</b><br>'.nl2br($record->job_desc); ?></font></p></td>
