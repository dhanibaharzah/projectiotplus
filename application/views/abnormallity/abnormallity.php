						...
						?>
							<tr id="<?php echo $record->id; ?>">
								...
								<td class="text-center">
									<?php if(!empty($record->imglink)){?><input type="button" value="View" class="btn btn-sm btn-primary" id="btn<?php echo $record->id; ?>"/><?php } ?>
									<a href="<?php echo base_url().'reuploadabn/'.$record->id; ?>" class="btn btn-sm btn-success" target="_blank"><i class="fa fa-upload"></i> Re-upload</a>
								</td>
								<td>
