<div class="content-wrapper">
	<section class="content-header">
		<h1>
			<i class="fa fa-warning"></i> My Abnormallity Reports
		</h1>
	</section>
				...
				<div class="box">
					<div class="box-header">
						<div class="row">
							<div class="col-md-12">
								<div class="box-tools">
								<form action="<?php echo base_url() ?>myabnormallity" method="POST" id="searchList">
...
<script type="text/javascript">
	jQuery(document).ready(function(){
		jQuery('ul.pagination li a').click(function (e){
			...
			jQuery("#searchList").attr("action", baseURL + "myabnormallity/" + value);
