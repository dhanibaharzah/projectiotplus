<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-database"></i> All Trouble
      </h1>
    </section>
        ...
        <div class="row">
            <div class="col-lg-12 col-xs-12">
              <div class="box">
				...
				<div class="col-lg-12 col-xs-12">
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>alltrouble" method="POST" id="searchList">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover table-striped table-bordered">
					...
					<?php
						...
						elseif ($record->sts == 'broken'){
							echo '<span class="label label-primary"> Broken</span>';
						}
						elseif ($record->sts == 'late'){
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "alltrouble/" + value);
