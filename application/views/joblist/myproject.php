<div class="content-wrapper">
	<section class="content-header">
		<h1>
			<i class="fa fa-copy"></i> My Project Job, LINE Get <b>myprj</b> & <b>myprj2</b> <small>Show approved project from today, with logged user as PIC</small>
		</h1>
	</section>
						...
						?>
							...
							<tr>
								<td class="text-center" colspan="4">
									<a href="<?php echo base_url(); ?>reportinfo/<?php echo $record->ticket_id; ?>" class="btn btn-success"><i class="fa fa-search"></i> View <span id="rep<?php echo $a; ?>"></span> Report(s)</a>
									<a href="<?php echo base_url(); ?>report/<?php echo $record->ticket_id; ?>" class="btn btn-primary" target="_blank"><i class="fa fa-sign-in"></i> Submit Report</a>
									<?php if($record->closed == 0){?>
									<a href="<?php echo base_url(); ?>closepic/<?php echo $record->ticket_id; ?>" class="btn btn-warning" target="_blank"><i class="fa fa-check"></i> Close Job</a>
									<?php } ?>
									...
									$(window).on('load', function(){
										...
										$('#pic<?php echo $a;?>').load('<?php echo base_url();?>piclist/<?php echo $record->ticket_id; ?>');
										$('#rep<?php echo $a;?>').load('<?php echo base_url();?>replist/<?php echo $record->ticket_id; ?>');
									});
								</script>
								</td>
							</tr>
