<div class="content-wrapper">
	<section class="content-header">
		<h1>
			<i class="fa fa-copy"></i> All Project Job
		</h1>
	</section>
					...
					<div class="box-header">
						<div class="row">
							<div class="col-lg-10 col-xs-8">
								<div class="box-tools">
									<form action="<?php echo base_url() ?>projectalljob" method="POST" id="searchList">
						...
						?>
							<tr>
								<td width="60%">
									...
									<?php echo '<b>Added by:'.$record->addedby; ?></b><br>
									<?php echo nl2br($record->job_desc); ?><br>
								</td>
								<td class="text-center">
									<?php if(($userdata->cdprj == 11 and $record->tag == 101) OR ($userdata->cdprj == 12 and $record->tag == 102)){?>
									<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#approve<?php echo $record->id; ?>"><i class="fa fa-check"></i> Approve</button>
									<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#reject<?php echo $record->id; ?>"><i class="fa fa-ban"></i> Reject</button>
									<div class="modal modal-success fade" id="approve<?php echo $record->id; ?>">
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													<button type="button" class="close" data-dismiss="modal" aria-label="Close">
												...
												<form role="form" id="edit_act" action="<?php echo base_url() ?>appprojectjob" method="post" role="form">
												<div class="modal-body">
													<label class="pull-left">Job Title:</label>
													<textarea onkeyup="lettersOnly(this)" type="text" name="title" rows="2" class="form-control" disabled><?php echo $record->job_title; ?></textarea>
													<label class="pull-left">Description:</label>
													<textarea onkeyup="lettersOnly(this)" type="text" name="desc" rows="4" class="form-control" disabled><?php echo $record->job_desc; ?></textarea>
												</div>
												<div class="modal-footer">
													<button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
													<input type="hidden" name="id" value="<?php echo $record->id;?>">
													<input type="hidden" name="tag" value="<?php echo $record->tag;?>">
													<input type="hidden" name="user" value="<?php echo $record->addedby;?>">
													<input type="submit" class="btn btn-outline" value="Approve">
												</div>
												</form>
											</div>
										</div>
									</div>
									<div class="modal modal-danger fade" id="reject<?php echo $record->id; ?>">
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													<button type="button" class="close" data-dismiss="modal" aria-label="Close">
												...
												<form role="form" id="edit_act" action="<?php echo base_url() ?>rjtprojectjob" method="post" role="form">
												<div class="modal-body">
													<label class="pull-left">Job Title:</label>
													<textarea onkeyup="lettersOnly(this)" type="text" name="title" rows="2" class="form-control" disabled><?php echo $record->job_title; ?></textarea>
													<label class="pull-left">Description:</label>
													...
													<textarea onkeyup="lettersOnly(this)" type="text" name="note1" rows="4" class="form-control" required></textarea>
												</div>
												<div class="modal-footer">
													<button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
													<input type="hidden" name="id" value="<?php echo $record->id;?>">
													<input type="hidden" name="tag" value="<?php echo $record->tag;?>">
													<input type="hidden" name="user" value="<?php echo $record->addedby;?>">
													<input type="submit" class="btn btn-outline" value="Reject">
												</div>
												</form>
											</div>
										</div>
									...
									<?php } ?>
									<?php if(($userdata->cdprj == 11 and ($record->tag == 101 OR $record->tag == 1)) OR ($userdata->cdprj == 12 and ($record->tag == 102 OR $record->tag == 2))){?>
									...
									<div class="modal modal-primary fade" id="edit<?php echo $record->id; ?>">
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<form role="form" id="edit_act" action="<?php echo base_url() ?>editappprojectjob" method="post" role="form">
												<div class="modal-body">
													<label class="pull-left">Job Title:</label>
...
<script type="text/javascript">
	jQuery(document).ready(function(){
		jQuery('ul.pagination li a').click(function (e) {
			...
			jQuery("#searchList").attr("action", baseURL + "projectalljob/" + value);
