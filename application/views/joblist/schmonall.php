			...
			<div class="table-responsive no-padding">
				<table class="table" style="border: 1px solid black;">
					<tr style="border: 1px solid black">
						...
						<th class="text-center" style="border: 1px solid black; padding:2px;"><font size="1">Action</font></th>
					</tr>
				<?php
					if(!empty($joblist)){
						$a=1;
				...
				?>
					<tr style="border: 1px solid black">
						...
						<td <?php if($record->closed == 1){ echo 'bgcolor="#00FF00"';} ?> style="border: 1px solid black; padding:2px;"><p style="line-height: 1.1"><font size="1"><?php echo '<b>Added by:</b>'.$record->addedby.' <b>Arranged by:</b>'.$record->owner.'<br><b>'.$record->job_title.'</b><br>'.nl2br($record->job_desc); ?></font></p></td>
						...
						<td class="text-center" style="border: 1px solid black; padding:2px;"><p style="line-height: 1.1"><font size="1">
						<?php if($record->closed == 0){?>
							<a href="<?php echo base_url();?>report/<?php echo $record->id;?>" class="btn btn-primary btn-block">Report</a><br>
							<a href="<?php echo base_url();?>close/<?php echo $record->id;?>" class="btn btn-success btn-block">Close</a>
						<?php } ?>
						</font></p></td>
