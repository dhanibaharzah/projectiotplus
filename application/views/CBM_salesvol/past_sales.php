<div class="content-wrapper">
	<section class="content-header">
		<h1>
			<i class="fa fa-copy"></i> Past Actual Volume
		</h1>
	</section>
							...
							<div class="col-md-12 col-xs-12">                                
								<div class="form-group">
									...
									<select id="prod" name="prod_id" class="form-control" required>
										...
										?>
										<option value="<?php echo $record->id; ?>"><?php echo $record->prod_name.'('.$record->unit.') Subclass: '.$record->subclass; ?></option>
										<?php } }?>
									</select>
								</div>
							</div>
...
<script>
	...
	$('#datepicker1').on('changeDate', function (selected) {
		...
		$('#getdate').load('<?php echo base_url(); ?>cbm_js_date_pastvol/' + date.getTime() + '/'+ linker);
