<div class="content-wrapper">
	<section class="content-header">
		<h1>
			<i class="fa fa-book"></i> Machine Sequence <small> state or flow diagrams </small> 
		</h1>
	</section>
										...
										<div class="modal modal-default fade" id="add_new">
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<form role="form" id="edit_act" action="<?php echo base_url() ?>createseq" method="post" role="form">
													<div class="modal-body">
														<label class="pull-left">Machine Sequence Title:</label>
														<textarea onkeyup="lettersOnly(this)" type="text" name="seq_title" rows="2" class="form-control" required></textarea>
													</div>
						...
						?>
							<tr>
								...
								<?php if($record->addedby == $name and $record->saved == 0 and $record->ena_rev == 1){?>
									<a class="btn btn-sm btn-info" href="<?php echo base_url().'seqedit/'.$record->id; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
								<?php } ?>
									<a class="btn btn-sm btn-warning" href="<?php echo base_url().'seqview/'.$record->id; ?>" title="View"><i class="fa fa-search"></i></a>
									<a class="btn btn-sm btn-success" href="<?php echo base_url().'seqprint/'.$record->id; ?>" title="Print" target="_blank"><i class="fa fa-print"></i></a>
									<a class="btn btn-sm btn-danger" href="<?php echo base_url().'seqpdf/'.$record->id; ?>" title="Pdf" target="_blank"><i class="fa fa-file-pdf-o"></i></a>
								<?php if($record->ena_rev == 1){?>	
									<a class="btn btn-sm btn-primary" href="<?php echo base_url().'seqrev/'.$record->id; ?>"><i class="fa fa-plus"></i> Revisi</a>
								<?php } ?>
								</td>
							</tr>
							<tr>
...
<script type="text/javascript">
	jQuery(document).ready(function(){
		jQuery('ul.pagination li a').click(function (e){
			...
			jQuery("#searchList").attr("action", baseURL + "seq_dt/" + value);
