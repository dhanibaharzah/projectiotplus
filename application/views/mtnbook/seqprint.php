				...
				<table class="table table-hover table-striped table-bordered">
							...
							<tr>
								...
								<?php if(!empty($seq1->seq_link)){?>
									<img src="<?php echo base_url(); ?>assets/dtdoc/seq/<?php echo $seq1->seq_link; ?>" height="300px">
								<?php } ?>
								</td>
							</tr>
							<tr>
								<th width=" 5%" class="text-center" style="border: 1px solid black;"><font size="1">No</font></th>
								<th width="40%" colspan="2" class="text-center" style="border: 1px solid black;"><font size="1">State</font></th>
								<th width="55%" colspan="2" class="text-center" style="border: 1px solid black;"><font size="1">Note</font></th>
							</tr>
						<?php
							if(!empty($seqA)){
								$a = 1;
						...
						?>
							<tr>
								<td class="text-center" style="border: 1px solid black;"><font size="1"><?php echo $a; ?></font></td>
								<td colspan="2" style="border: 1px solid black;"><font size="1"><?php echo nl2br($record->dex_name); ?></font></td>
								<td colspan="2" style="border: 1px solid black;"><font size="1"><?php echo nl2br($record->dex_note); ?></font></td>
							</tr>
						<?php
									$a++;
								}
						...
						?>
							<tr>
								...
								<?php if(!empty($seq2->seq_link)){?>
									<img src="<?php echo base_url(); ?>assets/dtdoc/seq/<?php echo $seq2->seq_link; ?>" height="300px">
								<?php } ?>
								</td>
							</tr>
							<tr>
