			...
			<div class="col-lg-12 col-xs-12">
				<table class="table table-hover table-striped table-bordered">
					<tr>
						...
						<td width="53%" class="text-center" colspan="2" style="border: 1px solid black;">
							<font size="4"><b><?php echo $opr->opr_title; ?></b></font>
							<br>
							<b><?php echo 'REV.'.$opr->rev;?></b>
						</td>
						<td width="32%" class="text-center" style="border: 1px solid black;">
					...
					<tr>
						<th width=" 4%" class="text-center" style="border: 1px solid black; padding: 1px;"><font size="1">No</font></th>
						<th width="32%" colspan="2" class="text-center" style="border: 1px solid black; padding: 1px;"><font size="1">Image</font></th>
						<th width="32%" class="text-center" style="border: 1px solid black; padding: 1px;"><font size="1">Step of Work</font></th>
						<th width="32%" class="text-center" style="border: 1px solid black; padding: 1px;"><font size="1">Parameter/Advice</font></th>
					</tr>
				<?php
					if(!empty($doc)){
						$a = 1;
				...
				?>
					<tr>
						<td width=" 4%" class="text-center" style="border: 1px solid black;"><font size="1"><?php echo $a; ?></font></td>
