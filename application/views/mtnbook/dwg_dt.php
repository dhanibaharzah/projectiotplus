<div class="content-wrapper">
	<section class="content-header">
		<h1>
			<i class="fa fa-code"></i> Design <small>Drawing and othres design file</small> 
		</h1>
	</section>
				...
				<div class="box">
					<div class="box-header">
						<div class="row">
							<div class="col-lg-12 col-xs-12">
								<div class="box-tools">
									<form action="<?php echo base_url() ?>dwg_dt" method="POST" id="searchList">
									<div class="col-md-2 form-group">
										<a class="btn btn-sm btn-success btn-block" href="<?php echo base_url()?>upload_dwg"><i class="fa fa-upload"></i> Upload</a>
									</div>
						...
						?>
							<tr>
								...
								<?php if($record->ena_rev == 1 and $record->saved== 0){?>
									<a class="btn btn-sm btn-primary" href="<?php echo base_url().'dwgrev/'.$record->id; ?>"><i class="fa fa-plus"></i> Rev</a>
									...
									<div class="modal modal-default fade" id="save_row<?php echo $record->id; ?>">
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<form role="form" id="edit_act" action="<?php echo base_url() ?>askappdwg" method="post" role="form">
												<div class="modal-body">
													Ask approval for <?php echo $record->dwg_name; ?>, are you sure?
												</div>
									...
									<div class="modal modal-danger fade" id="del_row<?php echo $record->id; ?>">
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<form role="form" id="edit_act" action="<?php echo base_url() ?>deldwg" method="post" role="form">
												<div class="modal-body">
													You will delete <?php echo $record->dwg_name; ?>, are you sure?
												</div>
												<div class="modal-footer">
													<input type="hidden" name="id" value="<?php echo $record->id; ?>">
													<button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
...
<script type="text/javascript">
	jQuery(document).ready(function(){
		jQuery('ul.pagination li a').click(function (e){
			...
			jQuery("#searchList").attr("action", baseURL + "dwg_dt/" + value);
