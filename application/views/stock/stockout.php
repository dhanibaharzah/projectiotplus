...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-gears"></i> Stock Control Out
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-xs-12">
                <div class="box box-primary">
					<form id="addstock" action="<?php echo base_url() ?>addstockout" method="post">
						<div class="box-body">
				...
				<div class="col-lg-12 col-xs-12">
					<div class="box box-primary">
						<div class="box-header">
							<form id="searchList" action="<?php echo base_url() ?>stockout" method="post">
                                 ...
                                 ?>
											<tr>	   
											  ...
											  <td class="text-center">
												  ...
												  ?>
												  <a class="btn btn-success btn-sm" href="<?php echo base_url();?>mortarout_app/<?php echo $record->id?>/1"><i class="fa fa-check"></i></a>  
												  <a class="btn btn-danger btn-sm" href="<?php echo base_url();?>mortarout_app/<?php echo $record->id?>/2"><i class="fa fa-close"></i></a>
												</td>
														...
														<div class="modal modal-danger fade" id="del<?php echo $record->id; ?>">
															<div class="modal-dialog">
																<div class="modal-content">
																	...
																	<form role="form" id="edit_act" action="<?php echo base_url() ?>deletestockout" method="post" role="form">
																	...
																	<div class="modal-footer">
																		...
																		<input type="hidden" name="redir" value="stockmortarout">
