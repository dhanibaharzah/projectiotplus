<div class="content-wrapper">
	<section class="content-header">
		<h1><i class="fa fa-gears"></i> Usage Setting</h1>
	</section>
					...
					<div class="box-header">
						<div class="row">
							<div class="col-lg-10 col-xs-8">
								<div class="box-tools">
								<form action="<?php echo base_url() ?>devusage" method="POST" id="searchList">
								...
								<div class="modal modal-default fade" id="add_new">
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<form role="form" id="edit_act" action="<?php echo base_url() ?>adddevusage" method="post" role="form">
											<div class="modal-body">
												<label class="pull-left">New Usage:</label>
												<textarea type="text" name="usage" rows="2" class="form-control" required></textarea>
											</div>
					...
					<div class="box-body table-responsive no-padding">
						...
						?>
							<tr>
								...
								<td align="center"><?php echo $record->device; ?></td>
								<td align="center">
									...
									<div class="modal modal-default fade" id="editposisi<?php echo $record->id; ?>">
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<form role="form" action="<?php echo base_url() ?>editdevusage" method="post" role="form">
												<div class="modal-body">
													<label class="pull-left">Usage:</label>
													<input type="text" name="usage" class="form-control" value="<?php echo $record->device; ?>" required>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "devusage/" + value);
