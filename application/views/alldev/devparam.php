<div class="content-wrapper">
	<section class="content-header">
		<h1><i class="fa fa-gears"></i> Parameter Setting</h1>
	</section>
		...
		<div class="row">
			<div class="col-lg-8 col-xs-12">
				<div class="box box-primary">
					...
					<form role="form" id="adddevice" action="<?php echo base_url() ?>devparam" method="post" role="form">
						...
						?>
							<tr>
								<td class="text-center">
									...
									<b><?php echo $record->param; ?></b>
								</td>
								<td class="text-center">
									<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editparam<?php echo $record->id; ?>"><i class="fa fa-pencil"></i></button>
									<div class="modal modal-default fade" id="editparam<?php echo $record->id; ?>">
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<form role="form" action="<?php echo base_url() ?>devparam" method="post" role="form">
												<div class="modal-body">
													<label class="pull-left">Parameter:</label>
													<input type="text" name="param" class="form-control" value="<?php echo $record->param; ?>" required>
									...
									<div class="modal modal-default fade" id="addsubclass">
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<form role="form" action="<?php echo base_url() ?>devparam" method="post" role="form">
												<div class="modal-body">
													<label class="pull-left">New Parameter:</label>
