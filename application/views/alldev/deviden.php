<div class="content-wrapper">
	<section class="content-header">
		<h1><i class="fa fa-gears"></i> Identification</h1>
	</section>
					...
					<div class="box-header">
						<div class="row">
							<div class="col-lg-10 col-xs-8">
								<div class="box-tools">
								<form action="<?php echo base_url() ?>deviden" method="POST" id="searchList">
								...
								<div class="modal modal-default fade" id="add_new">
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<form role="form" id="edit_act" action="<?php echo base_url() ?>adddeviden" method="post" role="form">
											<div class="modal-body">
												<label class="pull-left">New Identification Class:</label>
												<textarea type="text" name="iden" rows="2" class="form-control" required></textarea>
											</div>
					...
					<div class="box-body table-responsive no-padding">
						...
						?>
							<tr>
								...
								<td align="center"><?php echo $record->iden_name; ?></td>
								<td align="center">
									...
									<div class="modal modal-default fade" id="editposisi<?php echo $record->id; ?>">
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<form role="form" action="<?php echo base_url() ?>editdeviden" method="post" role="form">
												<div class="modal-body">
													<label class="pull-left">Usage:</label>
													<input type="text" name="iden" class="form-control" value="<?php echo $record->iden_name; ?>" required>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "deviden/" + value);
