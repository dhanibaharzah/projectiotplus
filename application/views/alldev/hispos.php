<div class="content-wrapper">
	<section class="content-header">
		<h1><a href="<?php echo base_url().'hisdevice/'.$id;?>" class="btn btn-sm btn-primary">BACK</a> <i class="fa fa-history"></i> Position Log of [<?php echo $xcode; ?>]</h1>
	</section>
				...
				<div class="box box-primary">
					<div class="box-header">
						...
						<div class="row">
							<div class="col-lg-12 col-xs-12">
								<div class="box-tools">
								<form action="<?php echo base_url() ?>hispos/<?php echo $xcode; ?>" method="POST" id="searchList">
					...
					<div class="box-body table-responsive">
						...
						?>
							<tr>
								...
								<td class="text-center"><?php echo $loc->posisi; ?></td>
								<td class="text-center"><?php echo $loc->usage; ?></td>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('ul.pagination li a').click(function (e) {
            ...
            jQuery("#searchList").attr("action", baseURL + "hispos/<?php echo $xcode; ?>/" + value);
