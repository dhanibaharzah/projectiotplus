	...
	<body class="login-page">
		<div class="box box-danger">
			...
			<div class="box-body">
				...
				<table class="table table-hover table-striped table-bordered ">
					...
					<tr><td width="20%"><b>Deskripsi</b></td><td width="80%">: <?php echo $jsa->description ?></td></tr>
					<tr><td width="20%"><b>Disetujui</b></td><td width="80%">: <?php echo $jsa->timestamp ?></td></tr>
				</table>
				<br>
					...
					?>
						<tr>
							...
							<td class="text-center">
								<?php if($record->report == !NULL){?>
									<?php echo $record->report; ?>
								<?php }else{ echo '<b>CO:</b> '.$record->gas1.' <b>O2:</b> '.$record->gas2.' <b>LEL:</b> '.$record->gas3.' <b>H2S:</b> '.$record->gas4; } ?>	
							</td>
							<td class="text-center">
								<?php if($record->report == !NULL){?>
									<?php echo $record->correction; ?>
								<?php }else{echo 'Terdapat Pengecekan Gas';} ?>	
							</td>
						</tr>
						<?php $a++; }}?>
					</table>
		...
		<div class="box box-danger">
			<div class="box-footer">
				<div class="row">
					<div class="col-xs-6">
						<a href="<?php echo base_url()?>reportx/<?php echo $jsa->id?>" class="btn btn-block btn-primary">Report</a>
					</div>
					<div class="col-xs-6">
						<a href="<?php echo base_url()?>close_hse/<?php echo $jsa->id?>" class="btn btn-block btn-success">Close Job</a>
					</div>
