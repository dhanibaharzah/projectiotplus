	...
	<body class="login-page">
		<div class="login-box">
			<div class="login-logo">
				<a href="#"><b>Approval Ijin Kerja</b><br><h3><?php echo $namejob->job_name?></h3></a>
			</div><!-- /.login-logo -->
			<div class="login-box-body">
				<p class="login-box-msg">Catatan:</p>
				<form action="<?php echo base_url(); ?>check_session_hse" method="post">
