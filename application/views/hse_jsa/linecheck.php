...
<html>
	...
	<body class="login-page">
		<div class="box box-danger">
			...
			<div class="box-body table-responsive">
				...
				<table class="table table-hover table-striped taable-bordered ">
					...
					<tr><td width="20%"><b>Tanggal</b></td><td width="80%">: <?php echo $jsa->start_date; ?> , <b>Jam : </b> <?php echo $jsa->start_hour.':00 - '.$jsa->end_hour.':00'; ?></td></tr>
		...
		<div class="box box-danger">
			...
			<div class="box-body table-responsive">
				<table class="table table-hover table-striped table-bordered ">
					<tr><td colspan="2" width="50%"><b>Tanggal Permohonan: </b><?php if($subdate != '07:00:00 01/01/1970'){echo $subdate;}else{echo $permit->created_on;} ?></td><td colspan="2" width="50%"><b>Pelaksana: </b><?php echo $jsa->user; ?></td></tr>
					<tr><td colspan="4"><b>A. PERMOHONAN</b> <small><?php echo $permit->id?></small><br>
						Nama Pekerjaan: <?php echo $jsa->job_name; ?><br>
						Lokasi: <?php echo $jsa->area; ?><br>
						Tanggal: <?php echo $jsa->start_date.', Jam: '.$jsa->start_hour.':00 - '.$jsa->end_hour.':00'; ?><br></td></tr>
				...
				if(!empty($cek2)){
					...
					foreach($cek2 as $listdata){
						...
						if($listdata->answer_type == 1){
							if($value == 1){$ans = 'YA';}
							elseif($value == 2){$ans = 'TIDAK';}
							elseif($value == 3){$ans = 'TIDAK PERLU';}
						}else{$ans = $value;}
			...
			<div class="box-body table-responsive">
				<table class="table table-hover table-striped table-bordered ">
					<tr>
						...
						><b>Pemilik Area Kerja:</b><br><?php echo $pic; ?><br><?php if(!empty($appdate2)){ echo $appdate2;}?></td>
						<td width="20%" align="center"
			...
			<div class="box-footer">
				<div class="row">
					<div class="col-xs-6">
						<a href="<?php echo base_url()?>checker/<?php echo $jsa->id?>/<?php echo $permit->id?>/1" class="btn btn-block btn-success">Approve</a>
					</div>
					<div class="col-xs-6">
						<a href="<?php echo base_url()?>checker/<?php echo $jsa->id?>/<?php echo $permit->id?>/2" class="btn btn-block btn-danger">Reject</a>
					</div>
				</div>
			</div>
		</div>
