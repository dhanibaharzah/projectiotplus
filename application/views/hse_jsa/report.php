	...
	<body class="login-page">
		<div class="box">
			<div class="box-body table-responsive">
				...
				<form action="<?php echo base_url(); ?>report_session_hse" method="post">
			</div>
			<div class="box-body">
				<div class="form-group has-feedback">
					...
					<textarea type="text" class="form-control" rows="5" name="correction" required></textarea>
					<button class="btn btn-default" disabled>Upload Image</button>
				</div>
				<div class="form-group has-feedback">
