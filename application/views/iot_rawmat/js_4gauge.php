...
<div class="col-md-<?php echo 12/$ena; ?> col-xs-6 text-center">
    ...
    <p><?php echo $mc_name_3; ?> <b><span id="col<?php echo $mc_name_3; ?>"></span></b> <?php echo $unit_3; ?></p>
</div>
<?php }if($ena > 3){ ?>
<div class="col-md-<?php echo 12/$ena; ?> col-xs-6 text-center">
...
<script>
    ...
    var gauge1<?php echo $ajax_link; ?> = new RadialGauge({
		...
		highlights: [
				{
					"from": <?php if(!empty($lower_tick1)){echo $lower_tick1; }else{echo '0';}?>, "to": lim1_1<?php echo $ajax_link; ?>,
					"color": "<?php echo $color_start1; ?>"//"#ff6363" //RED
				},{
					"from": lim1_1<?php echo $ajax_link; ?>, "to": lim1_2<?php echo $ajax_link; ?>,
					"color": "<?php if(!empty($color_mid1)){ echo $color_mid1;} else{echo "rgb(244, 229, 66)";} ?>" //YELLOW
				},{
					"from": lim1_2<?php echo $ajax_link; ?>, "to": lim1_3<?php echo $ajax_link; ?>,
					"color": "<?php echo $color_end1; ?>"//"rgb(86, 244, 65)" //GREEN
				}
			],
		colorPlate: "#fff",
		borderShadowWidth: 0,
...
<?php if($ena > 1){ ?>
    ...
    var gauge2<?php echo $ajax_link; ?> = new RadialGauge({
		...
		highlights: [
				{
					"from": <?php if(!empty($lower_tick2)){echo $lower_tick2; }else{echo '0';}?>, "to": lim2_1<?php echo $ajax_link; ?>,
					"color": "<?php echo $color_start2; ?>"//"#ff6363" //RED
				},{
					"from": lim2_1<?php echo $ajax_link; ?>, "to": lim2_2<?php echo $ajax_link; ?>,
					"color": "<?php if(!empty($color_mid2)){ echo $color_mid2;} else{echo "rgb(244, 229, 66)";} ?>" //YELLOW
				},{
					"from": lim2_2<?php echo $ajax_link; ?>, "to": lim2_3<?php echo $ajax_link; ?>,
					"color": "<?php echo $color_end2; ?>"//"rgb(86, 244, 65)" //GREEN
				}
			],
		colorPlate: "#fff",
		borderShadowWidth: 0,
...
<?php }if($ena > 2){ ?>
    ...
    var gauge3<?php echo $ajax_link; ?> = new RadialGauge({
		...
		height: 150,
		minValue: 0,
		maxValue: lim3_3<?php echo $ajax_link; ?>,
		valueBox: true,
		...
		highlights: [
				{
					...
					"color": "<?php echo $color_start3; ?>"//"#ff6363" //RED
				},{
					"from": lim3_1<?php echo $ajax_link; ?>, "to": lim3_2<?php echo $ajax_link; ?>,
					"color": "<?php if(!empty($color_mid3)){ echo $color_mid3;} else{echo "rgb(244, 229, 66)";} ?>" //YELLOW
				},{
					"from": lim3_2<?php echo $ajax_link; ?>, "to": lim3_3<?php echo $ajax_link; ?>,
					"color": "<?php echo $color_end3; ?>"//"rgb(86, 244, 65)" //GREEN
				}
			],
		colorPlate: "#fff",
		borderShadowWidth: 0,
